...
/*
  ...
  나이는 20세 이상 90세 미만인 사람만이 가입할 수 있고,
  주소 입력 시 '외국인'은 0으로 입력한다.
  성별은 '남자가 1,3' 여자는 '2,4'로 입력처리 후 , 저장은 '남자/여자'로 저장처리한다. 
...
public class T2Run {
	public static void main(String[] args) {
		...
		T2VO vo = new T2VO(); // alt + shift + R(rename)
		vo.setName(name);
		while(true) {
...
//  service.t2Print(name,age,address,sex); //sex가 안되므로 이렇게 하면 안됨
		service.t2Print(vo);
