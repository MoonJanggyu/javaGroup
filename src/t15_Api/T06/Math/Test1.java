...
public class Test1 {
	...
	// 반올림 : Math.round() - 무조건 정수형반올림(소수첫째자리에서 반올림 후 무조건 정수로 표시)
	System.out.println("d1:" + d1 + ", d2:" + d2);
	System.out.println("Math.round(d1):" + Math.round(d1) + " , " +Math.round(d2));
	...
	// 소수 셋째자리에서의 반올림 : 1234.567 + 0.005 = 1234.572 *100 (int)123457.2 / 100 = 1234.57
	...
	// 난수(Math.random()) : 0~1미만의 실수형 난수, (int)(Math.random()*(끝값+1-시작값) + 시작값)
