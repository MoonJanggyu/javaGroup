...
public class Test2 {
	public static void main(String[] args) {
		...
		String regEx5 = "^[a-zA-z가-힣 ]*$";    // 영문자와 한글 그리고 공백 체크
		String regEx6 = "^[a-zA-Z0-9가-힣 _-]*$";  // 영문자/한글/공백/숫자/밑줄/하이픈 만이 포함된 글자만을 허용
		...
		if(Pattern.matches(regEx3, str1)) System.out.println("11.이름이 영문과 한글로만 구성되어 있다.");
		else System.out.println("21.이름이 영문과 한글이 아닌 구성문자가 포함되어 있다.");
		...
		else System.out.println("31.공백이 아님 문자가 있습니다.");
