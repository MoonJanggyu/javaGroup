...
//	               012345678901234567890
		...
		// indexOf() : 찾고자 하는 문자(열)이 있는가? 있으면 위치값(인덱스값), 없으면 -1을 반환
		System.out.println("1.msg1에 'O'문자가 있는가? " + msg1.indexOf("O"));
		System.out.println("1.msg1에 'o'문자가 있는가? " + msg1.indexOf("o"));
		System.out.println("1.msg1에 'korea'문자가 있는가? " + msg1.indexOf("korea"));
		System.out.println("1.msg1에 'Korea'문자가 있는가? " + msg1.indexOf("Korea"));
		...
		//lastIndexOF()
		System.out.println("6.msg1에 'o'문자를 찾돼 뒤부터 검색후 몇번째 있는가? " + msg1.lastIndexOf("Korea"));
		System.out.println();
