...
public class T02_TreeMap {
	public static void main(String[] args) {
		...
		System.out.println("7. 첫번째 키와 키 : " + map.firstEntry());
		System.out.println("7. 검색키보다 작은 키 : " + map.lowerKey(18));
		System.out.println("7. 검색키보다 큰 키 : " + map.higherKey(18));
		System.out.println("7. 검색키보다 큰 값 : " + map.get(map.higherKey(18)));
		System.out.println();
