...
/*
 ...
 인덱스가 없다. 따라서 순차처리개념이 없다. 많은 자료의 순차 검색시는 많은 시간이 걸림.
...
public class Test1 {
	public static void main(String[] args) {
		...
		List<String> linkedList = new LinkedList<>();
		  ...
		  // 자료 검색(get)
		  System.out.println("4. " + linkedList.get(1));
		  System.out.println("4. " + linkedList.get(5));
		  System.out.println("4. " + linkedList.get(linkedList.size()-1));
		  System.out.println();
